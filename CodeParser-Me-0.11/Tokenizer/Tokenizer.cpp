...
namespace Scanner
{
  ...
  public:
    ...
    void setSpecialTokens(std::vector<std::string> OneCharList, std::vector<std::string> PairCharList);
...
void ConsumeState::setSpecialTokens(std::vector<std::string> OneCharList, std::vector<std::string> PairCharList)
{
  _pContext->_oneCharTokens.clear();
  _pContext->_twoCharTokens.clear();
  _pContext->_oneCharTokens = OneCharList;
  _pContext->_twoCharTokens = PairCharList;
...
void Toker::setSpecialTokens(std::vector<std::string> OneCharList, std::vector<std::string> PairCharList)
{
  pConsumer->setSpecialTokens(OneCharList, PairCharList);
}
