...
ConfigParseToConsole::~ConfigParseToConsole()
{
  ...
  delete pStatPrintFunction;
  delete pStatPushFunction;
  delete pStatFunctionDefinition;
...
Parser* ConfigParseToConsole::Build()
{
  try
  {
	...
	pStatFunctionDefinition = new StatFunctionDefinition;
	pStatPushFunction = new StatPushFunction(pRepo);  // no action
	pStatPrintFunction = new StatPrintFunction(pRepo);
	pStatFunctionDefinition->addAction(pStatPushFunction);
	pStatFunctionDefinition->addAction(pStatPrintFunction);
	pParser->addRule(pStatFunctionDefinition);
